...
class ERM(Algorithm):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # atts: torch tensor[128] | Probs: torch tensor[128, 2] | y: torch tensor[128] | preds: torch tensor[128]
        # to
        # atts: array(22280,) | Probs/preds_rounded: array(22280,) | y/targets: array(22280,) | preds/preds_rounded: array(22280,)(Bool)
        # label_set: array([0, 1])
        breakpoint()
        self.log_dict(
            output | prob_output,
